...
<html lang="en" class="no-js">
	...
	<body>
    <div class="box">
      <h1> Submit your model </h1><br>
      <form action='http://localhost:8000/csv_upload' enctype="multipart/form-data" method="post">
        <input type="text" name="name" placeholder="Name of model"><br><br>
        <input type="file" name="csvFile" id="file-1" accept=".csv" class="inputfile inputfile-1"/>
        <label for="file-1">
